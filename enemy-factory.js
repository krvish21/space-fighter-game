...
class EnemyFactory {
    static createEnemy(canvasWidth, canvasHeight, difficultyConfig = {}) {
        ...
        // For the remaining 15%, distribute among special enemies
        const remainingSpace = 1 - asteroidChance;
        const normalizedRoll = (roll - asteroidChance) / remainingSpace;
        
        console.log(`Spawning special enemy. Normalized roll: ${normalizedRoll.toFixed(3)}`);
